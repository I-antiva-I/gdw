 ...
 * @since WowEstore 1.0
 */
// [!] MODIFIED CSS level address-bar
get_header();
        ...
        <div class="container">
            <div class="columns is-desktop">
                <div class="column is-two-thirds-desktop">
                    ...
                    <div class="level address-bar level-search">
					...
					<?php if ( have_posts() ) : // [!] MODIFIED ?>
                        <div class="box">
                            <table class="table is-hoverable is-fullwidth">
                                <thead class="is-hidden-mobile">
                                <th class="has-text-left is-size-5">Articles</th>
								...
								the_post(); ?>
                                <tr onclick="window.location='<?php the_permalink();?>';">
                                    <td>
