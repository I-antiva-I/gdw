...
function iknow_scripts() {
	...
	// [!] MODIFIED
	wp_enqueue_style("my-custom-styles-vars", $template_uri."/assets/css/my-styles/my-style-vars.css");
	wp_enqueue_style("my-custom-styles-core", $template_uri."/assets/css/my-styles/my-style-core.css");
	wp_enqueue_style("my-custom-styles-blinks", $template_uri."/assets/css/my-styles/my-style-blinks.css");
	wp_enqueue_style("my-custom-styles-images", $template_uri."/assets/css/my-styles/my-style-images.css");
}
